...
class YamlListsTest extends TestCase
{
    ...
    {
        $file = __DIR__ . '/YamlFiles/ListStrings01.yaml';
    ...
    {
        $file = __DIR__ . '/YamlFiles/ListStrings02.yaml';
    ...
    {
        $file = __DIR__ . '/YamlFiles/ListStrings03.yaml';
