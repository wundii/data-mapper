...
class XmlApproachExtendedTest extends TestCase
{
    ...
    {
        $file = __DIR__ . '/XmlFiles/SharedSubSorted.xml';

        $dataConfig = new DataConfig(ApproachEnum::CONSTRUCTOR);
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->xml(file_get_contents($file), SharedSubSetter::class);
    ...
    {
        $file = __DIR__ . '/XmlFiles/SharedSubUnsorted.xml';
