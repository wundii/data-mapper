...
class NeonApproachExtendedTest extends TestCase
{
    public function testConstructorDefault(): void
    {
        $file = __DIR__ . '/NeonFiles/ApproachExtendedConstructor.neon';
    ...
    {
        $file = __DIR__ . '/NeonFiles/SharedSubSorted.neon';

        $dataConfig = new DataConfig(ApproachEnum::CONSTRUCTOR);
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->neon(file_get_contents($file), SharedSubSetter::class);
    ...
    {
        $file = __DIR__ . '/NeonFiles/SharedSubUnsorted.neon';
