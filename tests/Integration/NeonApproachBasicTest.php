...
class NeonApproachBasicTest extends TestCase
{
    public function testExceptionWrongSourceData(): void
    {
        $dataMapper = new DataMapper();
        $this->expectException(DataMapperException::class);
        $this->expectExceptionMessage('The Neon source is not a string');
        $dataMapper->map(SourceTypeEnum::NEON, [], BaseSetter::class);
    }
    ...
    public function testExceptionInvalidSourceData(): void
    {
        ...
        $this->expectExceptionMessage('Invalid Neon decode return');
        $dataMapper->map(SourceTypeEnum::NEON, '/', BaseSetter::class);
    }

    public function testConstructorDefault(): void
    {
        $file = __DIR__ . '/NeonFiles/ApproachBasicConstructor.neon';

        $dataConfig = new DataConfig(ApproachEnum::CONSTRUCTOR);
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->neon(file_get_contents($file), BaseConstructor::class);
    ...
    {
        $file = __DIR__ . '/NeonFiles/ApproachBasicProperty.neon';

        $dataConfig = new DataConfig(ApproachEnum::PROPERTY);
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->neon(file_get_contents($file), BaseProperty::class);
    ...
    {
        $file = __DIR__ . '/NeonFiles/ApproachBasicSetter.neon';

        $dataConfig = new DataConfig(ApproachEnum::SETTER);
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->neon(file_get_contents($file), BaseSetter::class);
    ...
    public function testSetterWithoutRightDataException(): void
    {
        ...
        $this->expectExceptionMessage('Invalid object from NeonResolver, could not create an instance of Integration\Objects\ApproachBasic\BaseSetter');
        $dataMapper = new DataMapper();
        $dataMapper->neon(file_get_contents($file), BaseSetter::class, ['string']);
    }
    ...
    public function testSetterWithoutRightData(): void
    {
        ...
        $dataMapper = new DataMapper();
        $return = $dataMapper->neon(file_get_contents($file), BaseSetter::class, ['string'], forceInstance: true);
    ...
    {
        $file = __DIR__ . '/NeonFiles/ApproachBasicSetterIncomplete.neon';

        $dataConfig = new DataConfig(ApproachEnum::SETTER);
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->neon(file_get_contents($file), BaseSetterWithConstructor::class);
    ...
    public function testSetterCustomMethod(): void
    {
        ...
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->neon(file_get_contents($file), BaseSetterCustomMethod::class);
    ...
    {
        $file = __DIR__ . '/NeonFiles/ApproachBasicSetterFail.neon';
    ...
    {
        $file = __DIR__ . '/NeonFiles/ApproachBasicSetterWithWrongTypeInSubSettersCreateInstanceWithoutConstructor.neon';
    ...
    {
        $file = __DIR__ . '/NeonFiles/ApproachBasicMix.neon';

        $dataMapper = new DataMapper();
        $return = $dataMapper->neon(file_get_contents($file), BaseMix::class);
    ...
    {
        $file = __DIR__ . '/NeonFiles/ApproachBasicMixCustomRootElementTree.neon';

        $dataConfig = new DataConfig(ApproachEnum::SETTER);
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->neon(file_get_contents($file), BaseMix::class, ['result']);
    ...
    public function testMixWithIncorrectCustomRootElementTreeWithoutForceInstance(): void
    {
        ...
        $this->expectException(DataMapperException::class);
        $this->expectExceptionMessage('Root-Element "incorrect" not found in Neon source data, you can use the forceInstance option to create an empty instance.');
        $dataMapper->neon(file_get_contents($file), BaseMix::class, ['incorrect']);
    }
    ...
    public function testMixWithIncorrectCustomRootElementTreeWithForceInstance(): void
    {
        ...
        $return = $dataMapper->neon(file_get_contents($file), BaseMix::class, ['incorrect'], true);
    ...
    public function testPrivateProperty(): void
    {
        ...
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->neon(file_get_contents($file), PrivateProperty::class);
    ...
    public function testPrivateSetter(): void
    {
        ...
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->neon(file_get_contents($file), PrivateSetter::class);
