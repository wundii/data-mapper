...
class IniApproachBasicTest extends TestCase
{
    public function testExceptionWrongSourceData(): void
    {
        $dataMapper = new DataMapper();
        $this->expectException(DataMapperException::class);
        $this->expectExceptionMessage('The Ini source is not a string');
        $dataMapper->map(SourceTypeEnum::INI, [], BaseSetter::class);
    }
    ...
    public function testExceptionInvalidSourceData(): void
    {
        ...
        $this->expectExceptionMessage('Invalid Ini decode return');
        $dataMapper->map(SourceTypeEnum::INI, 'items[ = "oops"', BaseSetter::class);
    }

    public function testConstructorDefault(): void
    {
        $file = __DIR__ . '/IniFiles/ApproachBasicConstructor.ini';

        $dataConfig = new DataConfig(ApproachEnum::CONSTRUCTOR);
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->ini(file_get_contents($file), BaseConstructor::class);
    ...
    {
        $file = __DIR__ . '/IniFiles/ApproachBasicProperty.ini';

        $dataConfig = new DataConfig(ApproachEnum::PROPERTY);
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->ini(file_get_contents($file), BaseProperty::class);
    ...
    {
        $file = __DIR__ . '/IniFiles/ApproachBasicSetter.ini';

        $dataConfig = new DataConfig(ApproachEnum::SETTER);
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->ini(file_get_contents($file), BaseSetter::class);
    ...
    public function testSetterWithoutRightDataException(): void
    {
        ...
        $this->expectExceptionMessage('Invalid object from IniResolver, could not create an instance of Integration\Objects\ApproachBasic\BaseSetter');
        $dataMapper = new DataMapper();
        $dataMapper->ini(file_get_contents($file), BaseSetter::class, ['string']);
    }
    ...
    public function testSetterWithoutRightData(): void
    {
        ...
        $dataMapper = new DataMapper();
        $return = $dataMapper->ini(file_get_contents($file), BaseSetter::class, ['string'], forceInstance: true);
    ...
    {
        $file = __DIR__ . '/IniFiles/ApproachBasicSetterIncomplete.ini';

        $dataConfig = new DataConfig(ApproachEnum::SETTER);
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->ini(file_get_contents($file), BaseSetterWithConstructor::class);
    ...
    public function testSetterCustomMethod(): void
    {
        ...
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->ini(file_get_contents($file), BaseSetterCustomMethod::class);
    ...
    {
        $file = __DIR__ . '/IniFiles/ApproachBasicSetterFail.ini';
    ...
    {
        $file = __DIR__ . '/IniFiles/ApproachBasicSetterWithWrongTypeInSubSettersCreateInstanceWithoutConstructor.ini';
    ...
    {
        $file = __DIR__ . '/IniFiles/ApproachBasicMix.ini';

        $dataMapper = new DataMapper();
        $return = $dataMapper->ini(file_get_contents($file), BaseMix::class);
    ...
    {
        $file = __DIR__ . '/IniFiles/ApproachBasicMixCustomRootElementTree.ini';

        $dataConfig = new DataConfig(ApproachEnum::SETTER);
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->ini(file_get_contents($file), BaseMix::class, ['result']);
    ...
    public function testMixWithIncorrectCustomRootElementTreeWithoutForceInstance(): void
    {
        ...
        $this->expectException(DataMapperException::class);
        $this->expectExceptionMessage('Root-Element "incorrect" not found in Ini source data, you can use the forceInstance option to create an empty instance.');
        $dataMapper->ini(file_get_contents($file), BaseMix::class, ['incorrect']);
    }
    ...
    public function testMixWithIncorrectCustomRootElementTreeWithForceInstance(): void
    {
        ...
        $return = $dataMapper->ini(file_get_contents($file), BaseMix::class, ['incorrect'], true);
    ...
    public function testPrivateProperty(): void
    {
        ...
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->ini(file_get_contents($file), PrivateProperty::class);
    ...
    public function testPrivateSetter(): void
    {
        ...
        $dataMapper = new DataMapper();
        $dataMapper->setDataConfig($dataConfig);
        $return = $dataMapper->ini(file_get_contents($file), PrivateSetter::class);
