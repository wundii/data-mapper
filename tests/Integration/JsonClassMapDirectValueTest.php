...
class JsonClassMapDirectValueTest extends TestCase
{
    public function testDateTimeBasic(): void
    {
        ...
        $return = $dataMapper->json(file_get_contents($file), DateTimeBasic::class);
    ...
    public function testDateTimeAlias(): void
    {
        ...
        $dataMapper = new DataMapper($dataConfig);
        $return = $dataMapper->json(file_get_contents($file), DateTimeAlias::class);
    ...
    public function testEnumBasic(): void
    {
        ...
        $dataMapper = new DataMapper($dataConfig);
        $return = $dataMapper->json(file_get_contents($file), EnumBasic::class);
