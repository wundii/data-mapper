...
class YamlClassMapDirectValueTest extends TestCase
{
    public function testDateTimeBasic(): void
    {
        $file = __DIR__ . '/YamlFiles/ClassMapDirectValueDateTime.yaml';
        ...
        $return = $dataMapper->yaml(file_get_contents($file), DateTimeBasic::class);
    ...
    public function testDateTimeAlias(): void
    {
        ...
        $dataMapper = new DataMapper($dataConfig);
        $return = $dataMapper->yaml(file_get_contents($file), DateTimeAlias::class);
    ...
    {
        $file = __DIR__ . '/YamlFiles/ClassMapDirectValueEnum.yaml';

        $dataConfig = new DataConfig(ApproachEnum::PROPERTY);
        $dataMapper = new DataMapper($dataConfig);
        $return = $dataMapper->yaml(file_get_contents($file), EnumBasic::class);
